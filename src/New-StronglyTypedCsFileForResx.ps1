...
$nameSpaceDict = @{
    "Microsoft.PowerShell.SHiPS" = "Microsoft.PowerShell.SHiPS"
}
...
$inputFilePath = Join-Path $projectRoot "$project/Resources/Resource.resx"

if ($nameSpaceDict.ContainsKey($project)) {
    $className = $nameSpaceDict[$project] + ".Resources.Resource"
